let firstNode = {name: 'Alexandra', next: '1'}
let secondNode = {name:'Kirstin', next: '2' }
let thirdNode = {name: 'Juliet', next: '3'}
let fourthNode = {name: 'Timmy', next: '4'}
let fifthNode = {name: 'Jacob', next: '5'}
